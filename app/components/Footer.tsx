        ...
        <div className="grid grid-cols-[1.6fr_1fr_1fr_1.4fr] gap-10 pb-[52px] border-b border-[rgba(255,255,255,0.12)]">
          <div>
            ...
            <img
              ...
              alt="Iron Yak Logo"
              className="block h-12 w-auto mb-5"
            />
            ...
            <div className="flex gap-2.5">
              {socials.map((s) => (
                <a
                  ...
                  href="#"
                  aria-label={s.label}
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-[rgba(255,255,255,0.08)] text-[16px] transition-[background] duration-200 hover:bg-[#EE6A22] hover:text-white"
                >
                  {s.icon}
                </a>
              ))}
