...
const paths = [
  ...
  // WORDMARK — "Iron" recolored light (#E6E7E8) for contrast on the dark loader; "Yak" stays orange.
  // These rise up from below and assemble left-to-right after the yak is formed (delays 2.4 → 3.0).
...
export function YakLoader({ onComplete }: YakLoaderProps) {
  ...
  useEffect(() => {
    // Total animation takes ~4s (max delay 3.0 for the wordmark + ~1s spring settle)
    // Hold for ~1s, then start fade out at 5.2s
